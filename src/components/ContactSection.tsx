        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-2 bg-gray-50 p-8 rounded-xl">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-white p-3 rounded-full shadow-sm hover:shadow-md transition-shadow" aria-label="LinkedIn">
                  <LinkedinIcon className="h-5 w-5 text-blue-600" />
                </a>
                <a href="#" className="bg-white p-3 rounded-full shadow-sm hover:shadow-md transition-shadow" aria-label="GitHub">
                  <GithubIcon className="h-5 w-5 text-gray-800" />
                </a>
                <a href="#" className="bg-white p-3 rounded-full shadow-sm hover:shadow-md transition-shadow" aria-label="Twitter">
          ...
          <div className="md:col-span-3 bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            ...
            <form className="space-y-6">
              ...
              <button type="submit" className="w-full bg-green-600 text-white font-medium py-3 rounded-md hover:bg-green-700 transition-colors">
                Send Message
              </button>
            </form>
          </div>
